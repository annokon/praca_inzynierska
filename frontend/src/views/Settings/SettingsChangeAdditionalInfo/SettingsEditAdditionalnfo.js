...
export default function SettingsEditAdditionalnfo() {
    const navigate = useNavigate();

    const items = [
        { key: "pronoun", label: "Edytuj zaimki", onClick: () => navigate("/settings-pronouns") },
        { key: "about", label: 'Edytuj "o mnie"', onClick: () => navigate("/settings-about-me") },
        ...
        { key: "license", label: "Edytuj prawo jazdy", onClick: () => navigate("/settings-driving-license") },
